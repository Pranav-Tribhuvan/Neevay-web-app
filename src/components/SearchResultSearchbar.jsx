...
const SearchResultSearchbar = () => {
    ...
    const handleChangeRegionValue = (e) => {
        ...
        setFilters(prev => ({ ...prev, selectedCities: [searchTerm] }));
    ...
    const handleSearchClick = (e) => {
        if (
            ...
            setError(false);
            // Perform search action using the filters
    ...
    return (
        ...
        >
            {/* vendor type */}
            <div
                onMouseEnter={() => setShowLeftDivider(false)}
                onMouseLeave={() => setShowLeftDivider(true)}
            ...
            <div
                onMouseEnter={() => { setShowLeftDivider(false); setShowRightDivider(false); }}
                onMouseLeave={() => { setShowLeftDivider(true); setShowRightDivider(true); }}
            ...
            {/* Region */}
            <div
                onMouseEnter={() => setShowRightDivider(false)}
                onMouseLeave={() => setShowRightDivider(true)}
                onClick={() => { setRegionClicked(!regionClicked); setSelectedSection("region"); }}
                className="relative"
                style={{
            ...
            >
                ...
                >
                    ...
                    <input
                        ...
                        value={filters.selectedCities[0] || ''}
                        onKeyDown={handleKeyDown}
                        onChange={handleChangeRegionValue}
                        placeholder="City"
                    />
                    <img src="https://storagereponeevaydevcdn.blob.core.windows.net/business/searchbar_arrow.svg" alt="" className="md:mr-2 lg:mx-2" />
                    {filters.selectedCities.length === 0 && error && (
                        <Tooltip
                            title="This field is required"
                            arrow
                            open
